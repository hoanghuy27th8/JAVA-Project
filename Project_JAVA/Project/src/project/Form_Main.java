...
//    }
    ...
    private void btnTimkiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimkiemActionPerformed
        if (txtMaNV.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Mã nhân viên không được rỗng !","Thông Báo", JOptionPane.WARNING_MESSAGE);
        ...
        try {
            ...
            if (nvm.timkiem(txtMaNV.getText()) != null) {
                ...
                cboPhongBan.setSelectedItem(nv.getPhongban().trim());
                ...
                JOptionPane.showMessageDialog(this, "Không tìm thấy nhân viên có mã " + txtMaNV.getText(),"Thông Báo",JOptionPane.WARNING_MESSAGE);
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Không thành công !" + e.getMessage(),"Lỗi",JOptionPane.ERROR_MESSAGE);
    ...
    private void btnChonanhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChonanhActionPerformed
        ...
        filename = f.getAbsolutePath(); // Lấy đường dẫn ảnh
        // tạo 1 ảnh vs (ScaledInstance) kích thước cửa Label ảnh đã tạo trước đó
...
// Hàm nhấn enter để tìm kiếm
    ...
    private void btnInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInActionPerformed
        try {
            XSSFWorkbook wordkbook = new XSSFWorkbook(); // tạo 1 excel
            XSSFSheet sheet = wordkbook.createSheet("DS Nhân viên");// tên trong Sheet của excel
            XSSFRow row = null; // dòng trong excel
            Cell cell = null;   // ô trong excel     
            row = sheet.createRow(0); // tạo dòng trong excel
            Header header = sheet.getHeader(); // chỉnh phần header
            header.setCenter("Center Header");
            Font font = wordkbook.createFont(); // chỉnh Font chữ
            font.setBold(true);
            ...
            style.setFillBackgroundColor(IndexedColors.BLUE_GREY.getIndex()); // chỉnh màu nền
            style.setFillPattern(FillPatternType.ALT_BARS);
            style.setFont(font); //ấp dụng Font chữ vào style
            
            cell = row.createCell(0, CellType.STRING);
            cell.setCellValue("Mã nhân viên");   // ô của dòng vừa tạo trong excel
            ...
            cell.setCellStyle(style);
            int i=0,tong=0;
            CreationHelper creationHelper  = wordkbook.getCreationHelper(); // chuyển ngày kiểu yyyy/mm/dd sang dd/mm/yyyy
            ...
            for(NhanVien nv:listNV){
                ...
                cell.setCellStyle(dateCellStyle); // ấp dụng Format dd/MM/yyyy        
                cell = row.createCell(3, CellType.STRING);
                ...
                cell = row.createCell(7, CellType.STRING);
                cell.setCellValue(nv.getPhongban());
                cell = row.createCell(8, CellType.STRING);
                ...
                cell = row.createCell(11, CellType.STRING);
                cell.setCellValue(nv.getThuong());
                cell = row.createCell(12, CellType.STRING);
                cell.setCellValue(nv.getTong());
                tong += Integer.parseInt(nv.getTong().trim());
                
                if(i==listNV.size()-1){
                    font = wordkbook.createFont();
                    font.setBold(true); 
                    font.setFontName("Arial");
                    font.setColor(IndexedColors.RED.getIndex());
                    font.setFontHeight((short) (11.5*20)); // cài kích thước chữ
                    style =wordkbook.createCellStyle();
                    style.setFont(font);
            ...
            File f = new File("D:\\Excel\\dsnv.xlsx");// Địa chỉ lưu xuất file
            try {
                FileOutputStream out = new FileOutputStream(f); 
                wordkbook.write(out);// Xuất ra
                out.close();
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        JOptionPane.showMessageDialog(this, "In thành công\nVui lòng kiểm tra tại D:\\Excel\\dsnv.xlsx");
